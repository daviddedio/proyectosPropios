    ...
    return (
        <div className='card' draggable onDragStart={e => startDrag(e, id, estado)}>
            <div className={`card-header ${vigencia}`}>
                <i className="fa-solid fa-pen-to-square toolTipConteiner"
                ...
                <i className="fa-solid fa-trash toolTipConteiner"
                    onClick={() => mostrarModal(<DeleteAction nro={id} funcion={funcion} titulo={titulo} />)}>
